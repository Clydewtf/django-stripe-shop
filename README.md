...
4. Через <ссылка на приложение (онлайн/локально)>/admin можно добавить свои товары
...
4. Реализовать Stripe Payment Intent вместо Stripe Session для более гибкой работы с платежами используя stripe.PaymentIntent.create вместо stripe.checkout.Session.create, написав свой фронт и дополнительную логику. Это даст больше контроля и возможностей над процессом платежей и кастомизацией
